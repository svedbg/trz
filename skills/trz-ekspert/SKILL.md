...
Всяка стойност, която потвърдиш от първоизточник, се записва в `stavki.md` заедно с
източника, статуса и датата на сверката — и се добавя ред в дневника на промените. Стойност
без статус е по-опасна от липсваща: следващият, който я ползва, няма как да знае дали е
сверена.

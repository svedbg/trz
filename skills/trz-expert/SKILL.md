...
За I1, I5 (само липсващи дни болничен при начислена сума), B1, B4, B5 и F5 скилът носи
`scripts/audit.py` — смята ги директно от файла, вместо да ги пресмяташ наум; ставките
идват свежи от `references/stavki/` при всяко изпълнение, не са вградени в скрипта.
Пусни го и вземи находките му за тези шест, преди да преминеш ръчно през тях; другите
проверки на B, F и I остават на анализа тук.

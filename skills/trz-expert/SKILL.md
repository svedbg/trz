...
За I1, I5 (само липсващи дни болничен при начислена сума), B1, B4, B5, F5, и
...
`ignore` — иначе тази част от скрипта отказва, вместо да гадае. Пусни го и вземи
находките му, преди да преминеш ръчно през тези проверки; другите проверки на B, F и I

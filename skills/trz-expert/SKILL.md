...
четири: преминава, не преминава, **недостатъчни данни** (проверката се дължи, но нещо
липсва — назови точно какво) или **неприложима** (материята я няма в този случай).
Двете последни не са едно и също и не се пишат едно вместо друго: първото е дупка в
проверката, второто не е. Редовете с недостатъчни данни са списъкът, с който завършва
отчетът.
...
Състоянията са четирите резултата от `proverki.md`, сведени до областта: **проверено**,
**недостатъчни данни**, **непроверимо** и **неприложима**. За всяка област, която не е
„проверено“, колоната „Защо“ казва точно какво липсва или пречи — това е и редът, по който
потребителят си набавя следващото.

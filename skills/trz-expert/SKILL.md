...
- Един и същ елемент влиза ли в осигурителния доход и в данъчната основа по един и същи
  ...
  **Освен когато законът предписва асиметрията.** Правилото важи за елементите, за които
  четенето е спорно — там е и стойността му. Има суми, при които разминаването между двете
  бази е самият закон: сумата по чл. 40, ал. 5 КСО е вътре в осигурителния доход и вън от
  данъчната основа, а обезщетенията по чл. 220 и чл. 224 КТ — точно обратното. Те са
  правилни така и находка по тях е грешна. Преди да обявиш асиметрия за противоречие,
  провери в `references/stavki.md` дали за елемента няма изрична норма; таблицата с
  режимите е в раздела за болничните.

...
- **Скилът е инсталиран като плъгин** (директорията се управлява от `/plugin` и се
  ...
  Вместо това създай в работната директория на потребителя файл `trz-stavki-mestni.md` с
  същите колони — стойност, период, основание, статус, дата — и го ползвай наред със
  справочника, като казваш изрично кои стойности идват от него.

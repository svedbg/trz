...
- **Нормативно основание** — акт и конкретен член/алинея. Без препратка находката не се
  включва в отчета. Изключение: находките от група K и находките за вътрешно
  противоречие — там основанието е самата аритметика и това се казва изрично, вместо да се
  посочва член наслуки.
...
- `true` — като еднократно плащане: **вън** от базата. Стойността по подразбиране.
...
настройка няма. Тогава действа `true`, но го кажи в отчета и питай потребителя при първия
файл, в който има бонус.

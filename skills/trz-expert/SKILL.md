...
Подреждай по тежест. Накрая — обобщение: брой засегнати лица и обща стойност на разликите,
ако е изчислима. Списъкът на липсващите данни се пише веднъж, в секцията „Отчетът завършва с
това, което не е проверено“ по-долу — не го повтаряй тук.
...
- **Подадени документи и какво липсва.** Изброй по вид: ведомост, договори и споразумения,
  присъствени форми, графици, заповеди за отпуск, болнични листове, вътрешни правила за
  работната заплата, Декларации обр. 1 и обр. 6, платежен файл, КИД на дружеството. За
  всеки — подаден ли е. Липсващият документ не е упрек; той е причината под него.
- **Проверки с резултат „недостатъчни данни“** — коя проверка, какво точно ѝ липсва и какво
  би се променило, ако бъде подадено. Проверките с резултат „неприложима“ **не** влизат
  тук: там няма какво да се подава.
...
със ставките. Пиши списъка, не процента.

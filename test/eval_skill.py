...
SAMPLE_TEXT = {
    ...
    "F9_health_on_sick_days": "здравната вноска за дните във временна неработоспособност е начислена и за дните за сметка на работодателя, чието възнаграждение вече носи здравно осигуряване",

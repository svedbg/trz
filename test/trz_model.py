...
# 60 лв. в евро, по фиксирания курс. Не се преписва като готово число, а се
# извежда — така stavki_test.py може да го сверява със справочника.
# СТАТУС: за потвърждение. Точното превалутиране е 30.6773; не е сверено дали
# законодателят е приел него, или го е закръглил. Виж stavki.md.
FIKSIRAN_KURS = 1.95583
PRAG_SOTSIALNI_RAZHODI = r2(60 / FIKSIRAN_KURS)      # 30.68
